 ...
 * @icon fa fa-circle-o
 */
class Weekrank extends Backend
{
    
    /**
     * Weekrank模型对象
     * @var \app\common\model\huoshan\Weekrank
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\common\model\huoshan\Weekrank;
    ...
    public function export()
    {
        ...
        $this->downloadExcel($newExcel, '火山周榜', 'Xls');
    }
