define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xigua/singlerank/index' + location.search,
                    add_url: 'xigua/singlerank/add',
                    edit_url: 'xigua/singlerank/edit',
                    del_url: 'xigua/singlerank/del',
                    multi_url: 'xigua/singlerank/multi',
                    table: 'xigua_single_rank',
