define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'huoshan/weekrank/index' + location.search,
                    add_url: 'huoshan/weekrank/add',
                    edit_url: 'huoshan/weekrank/edit',
                    del_url: 'huoshan/weekrank/del',
                    multi_url: 'huoshan/weekrank/multi',
                    table: 'huoshan_week_rank',
                }
            });
