define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'huoshan/totalrank/index' + location.search,
                    add_url: 'huoshan/totalrank/add',
                    edit_url: 'huoshan/totalrank/edit',
                    del_url: 'huoshan/totalrank/del',
                    multi_url: 'huoshan/totalrank/multi',
                    table: 'huoshan_total_rank',
